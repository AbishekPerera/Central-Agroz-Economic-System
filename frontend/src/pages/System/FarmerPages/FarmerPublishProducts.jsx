      ...
      <div className="contentContainer">
        ...
        <div className="content">
            ...
            <div className="row ">
              ...
              style={{ backgroundImage: "url('https://images.pexels.com/photos/8939514/pexels-photo-8939514.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')" 
              ,backdropFilter: "blur(20px) opacity(0.1)"}}>
                <br />
