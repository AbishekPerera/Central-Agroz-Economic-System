...
const FarmerDashboard = () => {
  return (
    ...
    <br />   
    <div className="corosal-farmer-dashboard" style={{ overflow: 'hidden', display: 'flex', justifyContent: 'center'}}>
    <Carousel>
            <Carousel.Item>
            <Carousel.Caption>
                <b><h1 style={{ color:"white" }}>CAES වෙත සාදරයෙන් පිළිගනිමු</h1></b>
            </Carousel.Caption>
    ...
    <Alert variant="info"  style={{ width: '100%'  }}>
              <Alert.Heading>View the Nearest Economic Center Details from here</Alert.Heading>
              {/* <hr /> */}
    </Alert>
    <Alert variant="primary"  style={{ width: '100%'  }}>
              <Alert.Heading>View Your GramaNiladari Details from here</Alert.Heading>
              {/* <hr /> */}
    </Alert>
    <Alert variant="secondary"  style={{ width: '100%'  }}>
              <Alert.Heading>View crops suitable for different climatic zones</Alert.Heading>
              {/* <hr /> */}
    </Alert>
    <Alert variant="danger" style={{ width: '100%' }}>
              <Alert.Heading>Instructions for common crop diseases, pest infestations and other related issues</Alert.Heading>
    </Alert>
    <br /> <br />
        </div>
      <SystemFooter />
